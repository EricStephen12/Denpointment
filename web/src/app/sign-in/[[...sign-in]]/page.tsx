...
export default function SignInPage() {
  return (
    <div className="min-h-screen flex w-full bg-ink-950 font-sans selection:bg-turq-400 selection:text-ink-950">
      ...
      {/* ── Right panel: Form ── */}
      <div className="flex-1 flex flex-col justify-center relative p-8 sm:p-12 lg:p-24 w-full bg-ink-950">
        <Link
          href="/"
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="mb-6">
            <p className="text-turq-400 text-xs tracking-[0.3em] uppercase">Patient Portal</p>
          </div>
