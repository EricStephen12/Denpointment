...
export default async function PaymentCallbackPage({
  ...
  if (!reference) {
    return (
      <div className="text-center py-16">
        ...
        <h1 className="text-xl font-display text-sand-50 mb-2">Missing payment reference</h1>
        <Link href="/dashboard/appointments" className="text-turq-400 hover:text-turq-300 font-medium text-sm">
  ...
  return (
    <div className="text-center py-16">
      {success ? (
        <>
          <CheckCircle2 className="h-12 w-12 text-turq-400 mx-auto mb-4" />
          <h1 className="text-xl font-display text-sand-50 mb-2">Payment successful</h1>
          <p className="text-sand-50/60 mb-6">Thank you — your payment has been recorded.</p>
        </>
      ) : (
        <>
          <XCircle className="h-12 w-12 text-red-400 mx-auto mb-4" />
          <h1 className="text-xl font-display text-sand-50 mb-2">Payment not completed</h1>
          <p className="text-sand-50/60 mb-6">{errorMessage || "The payment could not be verified. If you were charged, please contact the clinic."}</p>
        </>
      )}
      <Link href="/dashboard/appointments" className="text-turq-400 hover:text-turq-300 font-medium text-sm">
        Back to Appointments
