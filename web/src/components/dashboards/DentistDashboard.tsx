      ...
      <div className="border-t border-sand-50/10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-sand-50/8 border-b border-sand-50/10">
          {[
            ...
            { label: 'Upcoming', href: '/dashboard/treatments/upcoming' },
            { label: 'Past Treatments', href: '/dashboard/treatments/past' },
            { label: 'Statistics', href: '/dashboard/statistics/patients' },
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-[10px] uppercase tracking-[0.2em] text-sand-50/30">View</span>
