...
import { Calendar, FileText, Phone, ArrowRight, MapPin, Clock } from 'lucide-react';
  ...
  return (
    <div className="space-y-16">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-px bg-sand-50/10 border-y border-sand-50/10">
          {[
            ...
            { label: 'Directions', href: 'https://maps.google.com/?q=Glow+Dental+Kubwa+Abuja' },
          ].map(({ label, href }) => (
            <Link
              key={label}
              href={href}
